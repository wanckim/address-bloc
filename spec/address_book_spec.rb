...
RSpec.describe AddressBook do
  ...
  describe "#import_from_csv" do
    ...
    it "imports the first entry" do
      ...
      check_entry(entry_one, "Cindy", "333-333-4185", "cindy@example.com")
    end
    ...
    it "imports the second entry" do
      ...
      check_entry(entry_two, "Sam", "222-222-2668", "sam@example.com")
    end
    ...
    it "imports the third entry" do
      ...
      check_entry(entry_three, "Tom", "111-111-1234", "tom@example.com")
    end
  end
